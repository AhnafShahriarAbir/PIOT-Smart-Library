...
class barcode():
    ...
    def getQR(self):
        """This function is to use webcam to recogine the QR code and decode as its origin message,once the QR code is decoded ,it passes the value 
        to the return bookID
        """
