...
class recognise():
    """This is class is to implement the facial recgonistion techinology. To verify the face figured and compare with the trained image in the dataset where
    captured by the webcam and encoded already. 

    For useage:
    Once the code is executing , wait till the light is flasking on the webcam , it is starting to verify the face for user.

    We assume the user is pre-signed up with his unique email address already.
    """
    email = ""
