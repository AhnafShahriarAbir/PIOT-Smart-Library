    ...
    def display_menu(self):
        ...
        while True:
            ...
            if choice ==("1"):
                ...
                print(user_Email)
                Client.get_details(user_Email)  #: Using function from client.py,connecting to thes server

            elif choice==("3"):            
                user_Email=recogn.facial_recognise() #: calling facial recognistion function and assign new varabile to current function
                Client.get_details(user_Email)  #: Using function from client.py,connecting to thes server
